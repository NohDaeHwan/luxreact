...
function Appraisallist() {
    return (
        <MainCard title="검수 리스트">
            <AppraisalSearchBar></AppraisalSearchBar>
            <Grid container sx={{ pt: 2, "justifyContent":"end", mb: 2}} >
              <Grid item>
            ...
            <AppraisalTable customers={customers}></AppraisalTable>
